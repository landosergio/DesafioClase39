  ...
  static async restorePassword01(req, res) {
    ...
    try {
      let result = await transport.sendMail({
        ...
        html: `<a href="http://localhost:8080/api/sessions/restorePassword02/${userToken}">Entrá al link para restablecer tu contraseña</a></br>
  ...
  static async restorePassword02(req, res) {
    ...
    jwt.verify(token, privateKey, (error, credentials) => {
      ...
      if (error) {
        ...
        return res
          .status(400)
          .redirect("http://localhost:8080/restorePassword01");
      }
      ...
      res
        ...
        .redirect("http://localhost:8080/restorePassword02");
    });
  }
